...
namespace ChinookSystem.BLL
{
	public class PlaylistTrackServices
	{
		...
		public List<PlaylistTrackInfo> PlaylistTrack_FetchPlaylist(string playlistname, string username)
		{
			...
			//After copying from Linq we added the _context 
		...
		{
			//In local variables we need to add an instance of (change to singular) Tracks -> track
			//Add _context to all queries 
